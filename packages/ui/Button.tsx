      ...
      className: classNames(
        ...
        color === "secondary" &&
          (disabled
            ...
            : "border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 hover:text-gray-900 hover:shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-neutral-900 dark:bg-transparent dark:text-white dark:border-gray-300 dark:hover:bg-gray-500"),
        color === "alert" &&
          (disabled
            ? "border border-transparent bg-gray-400 text-white"
